...
export default function EmptyChatState() {
  return (
    <div className="flex-1 w-full bg-white flex flex-col items-center justify-center p-8 h-full">
      ...
      <h2 className="text-xl font-semibold text-gray-800 tracking-tight">No Recent Chat</h2>
      <p className="text-gray-500 text-center max-w-sm mt-2 text-sm">
         When you start a conversation, they will appear here. Select a thread from the list or start a new message!
      </p>
    </div>
  );
}
