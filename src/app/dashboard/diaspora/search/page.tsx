...
function DiasporaSearchContent() {
  return (
    <div className="w-full pb-12">
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
        <Link href="/dashboard/diaspora" className="hover:text-gray-900 transition-colors">
          Dashboard
        </Link>
...
export default function DiasporaSearchPage() {
  return (
    <Suspense fallback={
