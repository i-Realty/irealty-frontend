          ...
          <div style={{ width: 1216 }} className="mx-auto">
            ...
            <div className="grid grid-cols-3 gap-6">
              {categories.map((cat, i) => (
                <div key={i} className="relative rounded-lg overflow-hidden transform transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg" style={{ height: 250 }}>
