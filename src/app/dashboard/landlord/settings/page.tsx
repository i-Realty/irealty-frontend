...
// Landlord settings has 4 tabs -- same as seeker
const LANDLORD_TABS: { id: SettingsTab; icon: LucideIcon }[] = [
...
export default function LandlordSettingsPage() {
  ...
  const validTab = LANDLORD_TABS.find((t) => t.id === activeTab) ? activeTab : 'Profile';
