...
export default function ProgressPill({ step, total = 3 }: ProgressPillProps) {
  ...
  return (
    <div className="bg-white rounded-xl p-3.5 mb-3 sm:mb-4">
      <div className="flex items-center justify-between gap-3">
        <span className="text-xs text-[#8E98A8]">Step {step}/{total}</span>
        <span className="text-sm font-bold">{LABELS[step - 1]}</span>
        <div className="flex-1" />
        <div className="w-40">
          <div className="h-1.5 bg-indigo-50 rounded-full relative overflow-hidden">
            <div
