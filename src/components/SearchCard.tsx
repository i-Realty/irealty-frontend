  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="flex justify-center items-center bg-[#2563EB] rounded-full" style={{ width: 44, height: 44 }}>
      ...
      {activeTab !== "shortlet" && <PropertyTypeRadios activeTab={activeTab} />}
    </section>
  );
}

function PropertyTypeRadios({ activeTab }: { activeTab: TabName }) {
