          ...
          <div style={{ width: 1216 }} className="mx-auto">
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
              {properties.map((prop, i) => (
                <div key={prop.id} className="bg-white rounded-lg overflow-hidden shadow-sm border border-[#F1F1F1] transform transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg">
            ...
            <div className="flex justify-center">
              <button className="px-6 py-2 rounded-lg border border-[#2563EB] text-[#2563EB] font-bold" style={{ fontFamily: 'Lato', fontSize: 14 }}>View More Properties <span className="ml-2">→</span></button>
            </div>
          </div>
        </div>
      </div>
