...
import { User, CreditCard, FileText, HelpCircle, ClipboardList, type LucideIcon } from 'lucide-react';
...
import LandlordLeaseSettings from '@/components/dashboard/landlord/settings/LandlordLeaseSettings';
import AddAccountModal from '@/components/dashboard/agent/settings/AddAccountModal';

type LandlordTab = SettingsTab | 'Lease Management';

const LANDLORD_TABS: { id: LandlordTab; icon: LucideIcon }[] = [
  { id: 'Profile',          icon: User },
  { id: 'Payout',           icon: CreditCard },
  { id: 'Lease Management', icon: ClipboardList },
