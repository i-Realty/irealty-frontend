    ...
    <div className="flex flex-col h-full bg-white relative">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-5">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-200 border-2 border-white shadow-md relative mb-3">
            <Image
              src={user.avatar}
              alt={user.name}
              fill
        ...
        <div className="space-y-4">
          <div className="bg-gray-50/70 rounded-xl p-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[11px] font-medium text-gray-400">Joined</p>
                <p className="text-[13px] font-semibold text-gray-800">{user.joinDate}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <ArrowRightLeft className="w-4 h-4 text-gray-400 flex-shrink-0" />
              <div>
                <p className="text-[11px] font-medium text-gray-400">Total Transactions</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[11px] font-medium text-gray-400">KYC Status</p>
                <span
          ...
          <div className="bg-gray-50/70 rounded-xl p-4 space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-[12px]">
                ...
                <span className="text-gray-800 font-bold">{thread.id.toUpperCase()}</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-gray-400 font-medium">Category</span>
                <span className="text-gray-800 font-semibold">{thread.category}</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-gray-400 font-medium">Priority</span>
                <span className="text-gray-800 font-semibold">{thread.priority}</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-gray-400 font-medium">Status</span>
                <span className="text-gray-800 font-semibold">{thread.status}</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-gray-400 font-medium">Created</span>
                <span className="text-gray-800 font-semibold">{thread.createdAt}</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-gray-400 font-medium">Messages</span>
                <span className="text-gray-800 font-semibold">{thread.messages.length}</span>
              </div>
            </div>
          </div>
          ...
          <Link
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-50 hover:bg-blue-100 text-blue-600 font-bold text-[13px] rounded-xl transition-colors"
          >
